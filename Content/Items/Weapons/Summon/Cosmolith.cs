...
{
    public class Cosmolith : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.Summon.CosmolingMinion>();
            Item.shootSpeed = 1f;
            Item.buffType = ModContent.BuffType<Buffs.Summon.CosmolingMinionBuff>();
            Item.buffTime = 3600;
