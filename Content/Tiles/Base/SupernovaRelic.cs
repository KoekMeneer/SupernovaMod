...
namespace SupernovaMod.Content.Tiles.Base
{
    public abstract class SupernovaRelic : ModTile
    {
        public abstract int FrameWidth { get; }
		public abstract int FrameHeight { get; }
		public abstract int HorizontalFrames { get; }
		public abstract int VerticalFrames { get; }
		...
		public override string Texture => "SupernovaMod/Content/Tiles/Furniture/RelicPedestal";
